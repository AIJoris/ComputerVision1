...
label = 0
img = 0
# matfile['qualitative'][0][label][0][img]
# print(matfile['test_names'][0][0][0][:])
# print(matfile['qualitative'][0][3][199][0][0])
# print(len(matfile['test_names'][1][2]))
# quit()
ap = [round(float(elem),2) for elem in matfile['AP'][0]]
mean_ap = round(matfile['MAP'][0][0],2)

# Read HTML
with open('Template_Result_1.html','w') as f1:
