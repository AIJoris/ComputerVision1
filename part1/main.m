function main(n,r,k,method,fname_extension)
%% Specify paramters
...
fname = strcat('result_',int2str(fname_extension),'.mat');
save(fname,'qualitative','k','r','n_neg','n_pos','method','AP','MAP','n','test_names');
