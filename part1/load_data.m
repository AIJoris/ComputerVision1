...
[airplanes_test, airplanes_test_names] = load_dir('../Caltech4/ImageData/airplanes_test/', n);
[airplanes_train, ~] = load_dir('../Caltech4/ImageData/airplanes_train/', n);
[cars_test,cars_test_names]  = load_dir('../Caltech4/ImageData/cars_test/', n);
[cars_train, ~] = load_dir('../Caltech4/ImageData/cars_train/', n);
[faces_test, faces_test_names] = load_dir('../Caltech4/ImageData/faces_test/', n);
[faces_train,~] = load_dir('../Caltech4/ImageData/faces_train/', n);
[motorbikes_test, motorbikes_test_names] = load_dir('../Caltech4/ImageData/motorbikes_test/', n);
